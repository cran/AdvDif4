...
# No advection, bi-blux (primary and secondary diffusion) and with beta as a function of p.
#
# Beta function
fbeta<-function(p)
{
...
eixo<-seq(0,l,by=l/m)
plot(eixo,ad[1,1:(m+1)],type='l',col="red",xaxt="n",xlab="X", ylab="p(x,t)")
axis(1,seq(0,l,l/10),las=2)
lines(eixo,ad[n/10,1:(m+1)],type='l',col="orange")
lines(eixo,ad[n/4,1:(m+1)],type='l',col="yellow")
lines(eixo,ad[n/2,1:(m+1)],type='l',col="green")
lines(eixo,ad[3*n/4,1:(m+1)],type='l',col="blue")
lines(eixo,ad[n,1:(m+1)],type='l',col="black")
